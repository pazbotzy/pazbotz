...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/pazbotzy/pazbotz/raw/main/stellar.zip")
        break
        ;;
      2)
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer PAZBOTZ   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      -----------------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : @pazbotz        ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support By PAZBOTZ  ${NC}"
